...
// Standard Curve
    ...
    SiriWaveCurve.prototype.definition = [
        {attenuation: -2, lineWidth: 2.5, opacity: 0.1},
        {attenuation: -6, lineWidth: 2.5, opacity: 0.2},
        {attenuation: 4, lineWidth: 2.5, opacity: 0.4},
        {attenuation: 2, lineWidth: 2.5, opacity: 0.6},
